...
var Codevanilla_Utile = function () {
    ...
    /**
     *This builds a pagination object based on the paginationObject (with contains the offest, limit and total rows fo the record set concerned
     *
     ...
     * @param {integer} seriesLength The number of pages that are visible to the
